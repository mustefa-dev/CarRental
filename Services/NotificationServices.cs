...
using NotificationForm = Gaz_BackEnd.DATA.DTOs.Notifications.NotificationForm;
...
public class NotificationService : INotificationService{
    ...
    public async Task<(NotificationDto? notification, string?)> add(NotificationForm notificationForm) {
        var notification = _mapper.Map<CarRental.Entities.Notification>(notificationForm);
